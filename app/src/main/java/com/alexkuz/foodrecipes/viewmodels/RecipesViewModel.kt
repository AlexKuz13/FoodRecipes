...
import com.alexkuz.foodrecipes.data.MealAndDietType
...
import com.alexkuz.foodrecipes.util.Constants.Companion.QUERY_SEARCH
    ...
    fun showNetworkStatus() {
        if (!networkStatus) {
            ...
            if (networkStatus) {
                ...
                saveBackOnline(false) // а можно было без всякой хуйни backOnline
            }
    }
}